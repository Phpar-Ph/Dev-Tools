            ...
            <div className=" flex flex-col font-inter">
              ...
              <div>
                <h3 className=" max-w-4xl mx-auto leading-relaxed text-lg text-gray-600 dark:text-gray-400">
                  ...
                  journey and daily workflow. Whether you're a fellow developer,
                  a tech enthusiast, or just someone looking for useful
                  resources, you'll find a treasure trove of:{" "}
                </h3>
              </div>
            </div>
            <Card />
